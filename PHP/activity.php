<?php
if(isset($_POST['id']) && isset($_POST['login']) && isset($_POST['distance']) && isset($_POST['vitesse']) && isset($_POST['date'])&& isset($_POST['temps'])&& isset($_POST['note'])&& isset($_POST['sport'])){   // Include the necessary files
	...
	echo "Je rentre même pas dans le if";
}	
